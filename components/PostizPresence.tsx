...
const PILLARS = [
  ...
  { title: "Worn", copy: "The sponsor T-shirt" },
...
export default function PostizPresence() {
  ...
  const pillars=PILLARS.map(p=>p.title==="Worn"?{...p,copy:sponsor.name==="Your Brand"?"Branded apparel, worn well":`The ${sponsor.name} T-shirt`}:p);
