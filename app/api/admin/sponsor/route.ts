...
export async function PUT(request:Request){
  ...
  try{const body=await readBody(request);return NextResponse.json(await saveSponsorDraft(validateSponsorDetails(body.name,body.website,body.fundsRaised,body.fundingCurrency)),{headers:{"Cache-Control":"no-store"}});}
