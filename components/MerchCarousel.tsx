  ...
  return <div ref={root} className="orbit-showcase">
    <div className="orbit-stage" role="button" tabIndex={0}
      ...
      onPointerMove={e=>{
        ...
        if(Math.abs(dx)>8){d.moved=true;e.currentTarget.setPointerCapture(e.pointerId);angle.current=d.angle+dx/e.currentTarget.clientWidth*(mobile?STEP*2:Math.PI);}
      }}
