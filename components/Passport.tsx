  ...
  return <section ref={root} id="journey" aria-labelledby="passport-title" className={s.section} data-phase={phase}>
    <div className={s.inner}>
      ...
      <div className={s.spread}>
        <article className={`${s.page} ${s.identity}`} aria-label="Deepak’s Postiz passport of work">
          ...
          <div className={s.identityBody}>
            <figure className={s.photo}>{photoFailed?<div className={s.photoPlaceholder} aria-label="Deepak portrait awaiting upload"><span>D</span><small>DEEPAK</small></div>:<img src="/deepak-passport.webp" width="600" height="800" alt="Deepak wearing a dark suit and tie in an office" loading="lazy" onError={()=>setPhotoFailed(true)}/>}</figure>
        ...
        <article className={`${s.page} ${s.visas}`} aria-label="Visas for projects">
      ...
      <div className={s.props} aria-label="Travel essentials">
